...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;color:transparent;">
                <div class="row" >
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                       
                       
                    </div>
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px; color: mediumaquamarine; background-color:transparent; ">
                                        ...
                                        <div class="form-group">
                                            <div class="maxl">
                                                <label class="radio inline"> 
                                                    ...
                                                    <span style="color:black;font-size:larger;"> Male </span> 
                                                </label>
                                                <label class="radio inline"> 
                                                    <input type="radio" name="gender" value="Female">
                                                    <span style="color:black;font-size:larger;" >Female</span> 
                                                </label>
                                            </div>
                                            <a style="color:black;font-size:larger;" href="index1.php">Already have an account? Login Now</a>
                                        </div>
                                    </div>
