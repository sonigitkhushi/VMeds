...
<html lang="en">
  ...
  <body >
    ...
    <div class="container" style="background-color:transparent;">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style=" color: black;margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-hospital-o" aria-hidden="true"></i>&nbsp Care & Cure</h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="index.php" style="color: black;font-family: 'IBM Plex Sans', sans-serif;"><h6>Go Back</h6></a>
          </li>
    ...
    animation: mover 1s infinite alternate;">
         ...
         <div class="col-md-4" style="margin-top: 5%;right: 8%">
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;background-color:powderblue;">
            <div class="card-body">
              <center>
                <i class="fa fa-hospital-o fa-3x" aria-hidden="true" style="color:#0062cc"></i>
                <br>
              <h3 style="font-size:30px;color:black;margin-top: 10%">Patient Login</h3><br>
              <form class="form-group" method="POST" action="func.php">
                <div class="row" style="margin-top: 10%">
                  <div style="font-size:28px;color:black;"class="col-md-4"><label>Email: </label></div>
                  <div class="col-md-8"><input type="text" name="email" class="form-control" placeholder="Email" required/></div><br><br>
                  <div style="font-size:25px;color:black;margin-top:30px;"class="col-md-4" style="margin-top: 8%"><label>Password: </label></div>
